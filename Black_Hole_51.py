...
def find_best_chunk_strategy(input_filename, max_time_seconds):
    ...
    try:
        with open(compressed_filename, 'wb') as outfile:
            final_data = compress_with_paq(reverse_chunks_at_positions(file_data, best_chunk_size, best_positions), best_chunk_size, best_positions, file_size)
