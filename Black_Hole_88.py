...
def main():
    ...
    if mode == 1:
        ...
        try:
            num_attempts = int(input("Enter number of compression attempts: "))
            iterations_per_attempt = int(input("Enter number of iterations per attempt: "))
        except ValueError:
            print("Error: Invalid input. Please enter valid numbers for attempts and iterations.")
            return
