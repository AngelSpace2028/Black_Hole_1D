...
if os.path.basename(sys.argv[0]) != 'Black_Hole_5.py':
    sys.exit("This is not 'Black_Hole_5.py'.")
print("The script 'Black_Hole_5.py' is currently running.")
class compression:
                            ...
                            if Ex == 1:
                                ...
                                while Find != 1:
                                    ...
                                    while block < long_F:
                                        ...
                                        # print(Find)
                                        block += En
                                    if Find == 2 or Row == (2**14) -2 :
                                        Find = 1
                                        Extract1 = 1
                                    elif Row == (2**14) - 3 and Find == 3:
